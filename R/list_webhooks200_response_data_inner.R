#' Create a new ListWebhooks200ResponseDataInner
#'
#' @description
#' ListWebhooks200ResponseDataInner Class
#'
#' @docType class
#' @title ListWebhooks200ResponseDataInner
#' @description ListWebhooks200ResponseDataInner Class
...
#' @export
ListWebhooks200ResponseDataInner <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new ListWebhooks200ResponseDataInner class.
    #'
    #' @param id id
    ...
    initialize = function(`id` = NULL, `project_id` = NULL, `event_type` = NULL, `target_url` = NULL, `disabled` = NULL, `failure_count` = NULL, `last_delivered_at` = NULL, `created_at` = NULL, ...) {
      if (!is.null(`id`)) {
    ...
    #'
    #' @return ListWebhooks200ResponseDataInner as a base R list.
    #' @examples
    #' # convert array of ListWebhooks200ResponseDataInner (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ListWebhooks200ResponseDataInner to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      ListWebhooks200ResponseDataInnerObject <- list()
      if (!is.null(self$`id`)) {
        ListWebhooks200ResponseDataInnerObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`project_id`)) {
        ListWebhooks200ResponseDataInnerObject[["project_id"]] <-
          self$`project_id`
      }
      if (!is.null(self$`event_type`)) {
        ListWebhooks200ResponseDataInnerObject[["event_type"]] <-
          self$`event_type`
      }
      if (!is.null(self$`target_url`)) {
        ListWebhooks200ResponseDataInnerObject[["target_url"]] <-
          self$`target_url`
      }
      if (!is.null(self$`disabled`)) {
        ListWebhooks200ResponseDataInnerObject[["disabled"]] <-
          self$`disabled`
      }
      if (!is.null(self$`failure_count`)) {
        ListWebhooks200ResponseDataInnerObject[["failure_count"]] <-
          self$`failure_count`
      }
      if (!is.null(self$`last_delivered_at`)) {
        ListWebhooks200ResponseDataInnerObject[["last_delivered_at"]] <-
          self$`last_delivered_at`
      }
      if (!is.null(self$`created_at`)) {
        ListWebhooks200ResponseDataInnerObject[["created_at"]] <-
          self$`created_at`
      }
      return(ListWebhooks200ResponseDataInnerObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of ListWebhooks200ResponseDataInner
    #'
    #' @param input_json the JSON input
    #' @return the instance of ListWebhooks200ResponseDataInner
    ...
    #' @return ListWebhooks200ResponseDataInner in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to ListWebhooks200ResponseDataInner and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of ListWebhooks200ResponseDataInner
    toString = function() {
      self$toJSONString()
    },
...
# ListWebhooks200ResponseDataInner$unlock()
#
## Below is an example to define the print function
# ListWebhooks200ResponseDataInner$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# ListWebhooks200ResponseDataInner$lock()
