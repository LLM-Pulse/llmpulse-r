#' Create a new PromptSummaryResponse
#'
#' @description
#' PromptSummaryResponse Class
#'
#' @docType class
#' @title PromptSummaryResponse
#' @description PromptSummaryResponse Class
...
#' @field data  list(\link{PromptSummaryRow}) [optional]
#' @field request_id  character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
PromptSummaryResponse <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new PromptSummaryResponse class.
    #'
    ...
    initialize = function(`project_id` = NULL, `from` = NULL, `to` = NULL, `filters` = NULL, `breakdown` = NULL, `sort` = NULL, `sort_dir` = NULL, `page` = NULL, `per_page` = NULL, `total` = NULL, `data` = NULL, `request_id` = NULL, ...) {
      ...
      if (!is.null(`sort_dir`)) {
        if (!(is.character(`sort_dir`) && length(`sort_dir`) == 1)) {
          stop(paste("Error! Invalid data for `sort_dir`. Must be a string:", `sort_dir`))
        }
    ...
    #'
    #' @return PromptSummaryResponse as a base R list.
    #' @examples
    #' # convert array of PromptSummaryResponse (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert PromptSummaryResponse to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      PromptSummaryResponseObject <- list()
      if (!is.null(self$`project_id`)) {
        PromptSummaryResponseObject[["project_id"]] <-
          self$`project_id`
      }
      if (!is.null(self$`from`)) {
        PromptSummaryResponseObject[["from"]] <-
          self$`from`
      }
      if (!is.null(self$`to`)) {
        PromptSummaryResponseObject[["to"]] <-
          self$`to`
      }
      ...
      if (!is.null(self$`sort`)) {
        PromptSummaryResponseObject[["sort"]] <-
          self$`sort`
      }
      if (!is.null(self$`sort_dir`)) {
        PromptSummaryResponseObject[["sort_dir"]] <-
          self$`sort_dir`
      }
      if (!is.null(self$`page`)) {
        PromptSummaryResponseObject[["page"]] <-
          self$`page`
      }
      if (!is.null(self$`per_page`)) {
        PromptSummaryResponseObject[["per_page"]] <-
          self$`per_page`
      }
      if (!is.null(self$`total`)) {
        PromptSummaryResponseObject[["total"]] <-
          self$`total`
      }
      if (!is.null(self$`data`)) {
        PromptSummaryResponseObject[["data"]] <-
          self$extractSimpleType(self$`data`)
      }
      if (!is.null(self$`request_id`)) {
        PromptSummaryResponseObject[["request_id"]] <-
          self$`request_id`
      }
      return(PromptSummaryResponseObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of PromptSummaryResponse
    #'
    #' @param input_json the JSON input
    #' @return the instance of PromptSummaryResponse
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`sort_dir`)) {
      ...
      if (!is.null(this_object$`data`)) {
        self$`data` <- ApiClient$new()$deserializeObj(this_object$`data`, "array[PromptSummaryRow]", loadNamespace("llmpulse"))
      }
    ...
    #' @return PromptSummaryResponse in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to PromptSummaryResponse and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of PromptSummaryResponse
    toString = function() {
      self$toJSONString()
    },
...
# PromptSummaryResponse$unlock()
#
## Below is an example to define the print function
# PromptSummaryResponse$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# PromptSummaryResponse$lock()
