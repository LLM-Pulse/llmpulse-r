...
cd llmpulse-r
R CMD build .
R CMD check llmpulse_1.47.0.tar.gz --no-manual
R CMD INSTALL --preclean llmpulse_1.47.0.tar.gz
```
...
```R
install.packages("llmpulse_1.47.0.tar.gz", repos = NULL, type = "source")
```
